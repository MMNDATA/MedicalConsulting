...
CBCP$mlt[CBCP$pe == "0" & CBCP$dvt == "1" & CBCP$te == "1"]  <- "2"
CBCP$mlt[CBCP$pe == "1" & CBCP$dvt == "1" & CBCP$te == "1"]  <- "3"
...
mltmod <- vglm(mlt~covid_19+pe_hx+dvt_hx+race+ethnicity+factor_v+readmit_30d+PVD+Hemiplegia+LiverDis+CHF, cv+CKD+htn, family = multinomial, data =CBCP)  # vglm = vector GLM
summary(mltmod)

temod <- glm(te~.-dvt-pe-mrn-mlt, data=CBCP, family = binomial(link = "logit"))
summary(temod)
```